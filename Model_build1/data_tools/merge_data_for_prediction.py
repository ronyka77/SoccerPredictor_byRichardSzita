...
# Set up logging
log_file_path = './Model_build1/data_tools/log/merged_data.log'
...
def get_future_matches(collection, historical_data):
    ...
    future_matches.to_excel('./Model_build1/data_to_merge.xlsx')
    print('exported')
...
def main():
    ...
    historical_data = load_historical_data("./Model_build1/data/model_data_prediction_withPoisson.xlsx")
    ...
    future_matches.to_excel('./Model_build1/data/merged_data_prediction.xlsx', index=False)
