...
training_data_path = './Model_build1/data/model_data_training.csv'
prediction_data_path = './Model_build1/data/model_data_prediction.csv'
...
training_export_path = './Model_build1/data/model_data_training_withELO.xlsx'
prediction_export_path = './Model_build1/data/model_data_prediction_withELO.xlsx'
