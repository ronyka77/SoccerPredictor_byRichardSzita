...
# Set up logging
log_file_path = './Model_build1/score_prediction/test/log/stacked_' + model_type + '_model_training.log'
...
stacked_home_path = './Model_build1/predictions_hybrid_2fit_home_goals.xlsx'
stacked_away_path = './Model_build1/predictions_hybrid_2fit_away_goals.xlsx'
stacked_outcome_path = './Model_build1/predictions_hybrid_2fit_match_outcome.xlsx'
...
stacked_merged_df.to_excel('./Model_build1/predictions_stacked_2fit_merged.xlsx')