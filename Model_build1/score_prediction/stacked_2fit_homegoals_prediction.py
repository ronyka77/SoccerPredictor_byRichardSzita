...
#     model_file, 
#     keras_nn_model_path, 
#     custom_objects={'within_range_metric': within_range_metric}
# )

# # Access the stacking regressor and Keras model if needed
# stacking_regressor = loaded_model.stacking_regressor
# keras_nn_model = loaded_model.keras_model
# print("class load successfull")
...
prediction_data[model_type + '_prediction'] = predictions
# Save the predictions to an Excel file
# prediction_output = pd.DataFrame(predictions, columns=['predicted_goals'])
prediction_data.to_excel('predicted_'+ model_type +'_output_CHECK.xlsx', index=False)
