...
rolling_dataframe.to_excel('./SoccerPredictor_byRichardSzita/data/model_data_prediction.xlsx')
...
# final_dataframe.to_excel('./SoccerPredictor_byRichardSzita/data/model_data_prediction.xlsx')
