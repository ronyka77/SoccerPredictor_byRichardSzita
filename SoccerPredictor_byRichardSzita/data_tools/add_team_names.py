...
base_path = './SoccerPredictor_byRichardSzita/data/model_data_prediction.xlsx'
prediction_path = './SoccerPredictor_byRichardSzita/hybrid_predictions.xlsx'
...
updated_df.to_excel('./SoccerPredictor_byRichardSzita/hybrid_predictions_with_names.xlsx')
