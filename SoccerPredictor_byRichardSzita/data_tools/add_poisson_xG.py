...
training_data_path = './SoccerPredictor_byRichardSzita/data/model_data_training_withELO.xlsx'
prediction_data_path = './SoccerPredictor_byRichardSzita/data/model_data_prediction_withELO.xlsx'
