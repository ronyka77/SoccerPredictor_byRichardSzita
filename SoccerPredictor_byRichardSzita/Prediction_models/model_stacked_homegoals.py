...
base_data_path = './SoccerPredictor_byRichardSzita/data/model_data_training.csv'
new_prediction_path = './SoccerPredictor_byRichardSzita/data/merged_data_prediction.xlsx'
real_scores_path = './SoccerPredictor_byRichardSzita/hybrid_predictions_with_names.xlsx'
...
def make_prediction(model_type, model, residual_model, prediction_data):
    ...
    output_file = f'./SoccerPredictor_byRichardSzita/predictions_hybrid_{model_type}_1.xlsx'
