...
stacking_regressor = train_model(base_data, data, 'home_goals')
...
if len(data_with_error)>0:
    ...
    make_prediction('home_goals',stacking_regressor,prediction_df, residual_model_home)
else: 
    make_prediction('home_goals',stacking_regressor,prediction_df, 0)
